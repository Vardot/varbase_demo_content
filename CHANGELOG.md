...
All notable changes to the Varbase Demo Content recipe are documented in this file.
...
## [1.0.0] - 2026-09-06
### Changed
- Release the stable Varbase Demo Content 1.0.0 recipe with the Varbase 11.0.0 suite. No functional changes since 1.0.0-rc1.
- Pin the `drupal/varbase_media_assets` dependency to `~1.0.0`.
...
### Changed
- Maintenance and dependency updates for the Varbase Demo Content recipe.

## [1.0.0-alpha1]
### Added
- Initial release of the Varbase Demo Content recipe.

[Unreleased]: https://git.drupalcode.org/project/varbase_demo_content/-/compare/1.0.0...1.0.x
[1.0.0]: https://git.drupalcode.org/project/varbase_demo_content/-/compare/1.0.0-rc1...1.0.0
