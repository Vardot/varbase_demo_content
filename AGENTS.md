...
Guidance for AI coding agents working on the Varbase Demo Content recipe.
...
- **Merge request comments and history** on
  [git.drupalcode.org/project/varbase_demo_content](https://git.drupalcode.org/project/varbase_demo_content/-/merge_requests)
  — the reasoning behind recent changes lives in the MR discussions.
- **Issue comments** on
  [drupal.org/project/issues/varbase_demo_content](https://www.drupal.org/project/issues/varbase_demo_content)
